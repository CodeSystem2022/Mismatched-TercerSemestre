...
public class TestEnumeraciones {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nro de paises en el 3er. continente: " + Continentes.ASIA.getPaises());
        System.out.println("Nro de habitantes en el 3er. continente: " + Continentes.ASIA.getHabitantes());
    ...
    private static void indicarDiaSemana(Dias dias) {
        switch (dias) {
            ...
            case DOMINGO:
                ...
                break;
            default:
                System.out.println("No es un dia contemplado");
                break;
        }
    }
}
